...
namespace CryptoNote
{
    namespace parameters
    {
        ...
        const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX = 1627;
        ...
        const size_t CRYPTONIGHT_DEV = 0;
        ...
        const char GENESIS_COINBASE_TX_HEX[] =
            ...
            "d9e4c27d31ec7a68ea568b19488cfcb422659a07a0e44dd6", "721540165451801122838259073430870606171806533662";
        ...
        /* This is the unix timestamp of the first "mined" block (technically block 2, not the genesis block)
           You can get this value by doing "print_block 2" in DeployCoind. It is used to know what timestamp
        ...
        /* The mixin to use by default with zedwallet and Deploy-service */
        ...
        const uint32_t UPGRADE_HEIGHT_V5 = 1200000; // Upgrade height for CN-Deploy Variant 2 switch.
    ...
    const char CRYPTONOTE_NAME[] = "DeployCoin";
    ...
    const std::unordered_map<uint8_t, std::function<void(const void *data, size_t length, Crypto::Hash &hash)>>
        HASHING_ALGORITHMS_BY_BLOCK_VERSION = {
            ...
            {BLOCK_MAJOR_VERSION_5, Crypto::cn_Deploy_lite_slow_hash_v2}, /* UPGRADE_HEIGHT_V5 */
    ...
    const char LATEST_VERSION_URL[] = "http://latest.deploy-coin.com";

    const std::string LICENSE_URL = "https://github.com/Deploy-Coin/Deploycoin/blob/master/LICENSE";

    const static boost::uuids::uuid CRYPTONOTE_NETWORK = {
        {0xb5, 0x0c, 0x4a, 0x6c, 0xcf, 0x52, 0x57, 0x12, 0x78, 0xf1, 0x29, 0xa9, 0xb7, 0xc3, 0x25, 0xe1}};

    const char *const SEED_NODES[] = {
        "45.66.10.84:11897", // CuveeRO
        "85.209.88.77:11897",
        "45.66.8.215:11897" // CuveeCZ
    };
} // namespace CryptoNote
