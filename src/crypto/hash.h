...
// Standard Cryptonight-Dev Definitions
#define CN_PAGE_SIZE 2097152
#define CN_SCRATCHPAD 2097152
#define CN_ITERATIONS 1048576

// Standard Cryptonight-Dev Lite Definitions
#define CN_LITE_PAGE_SIZE 2097152
#define CN_LITE_SCRATCHPAD 1048576
#define CN_LITE_ITERATIONS 524288

// Standard Cryptonight-Dev Dark
#define CN_DARK_PAGE_SIZE 524288
#define CN_DARK_SCRATCHPAD 524288
#define CN_DARK_ITERATIONS 262144

// Standard Cryptonight-Dev Deploy
#define CN_Deploy_PAGE_SIZE 262144
#define CN_Deploy_SCRATCHPAD 262144
#define CN_Deploy_ITERATIONS 131072

// Cryptonight-Dev Soft Shell Definitions
...
#error The Cryptonight-Dev Soft Shell Parameters you supplied will exceed normal paging operations.
#endif
...
#include "hash-ops.h"
    ...
    /*
      Cryptonight-Dev hash functions
    */
    ...
    // Standard Cryptonight-Dev Dark Lite
    ...
    // Standard Cryptonight-Dev Deploy
    inline void cn_Deploy_slow_hash_v0(const void *data, size_t length, Hash &hash)
    {
        cn_slow_hash(
            data,
            length,
            ...
            0,
            CN_Deploy_PAGE_SIZE,
            CN_Deploy_SCRATCHPAD,
            CN_Deploy_ITERATIONS);
    }

    inline void cn_Deploy_slow_hash_v1(const void *data, size_t length, Hash &hash)
    {
        cn_slow_hash(
            data,
            length,
    ...
    inline void cn_Deploy_slow_hash_v2(const void *data, size_t length, Hash &hash)
    {
        cn_slow_hash(
            data,
            length,
    ...
    // Standard Cryptonight-Dev Deploy Lite
    inline void cn_Deploy_lite_slow_hash_v0(const void *data, size_t length, Hash &hash)
    {
        cn_slow_hash(
            data,
            length,
    ...
    inline void cn_Deploy_lite_slow_hash_v1(const void *data, size_t length, Hash &hash)
    {
        cn_slow_hash(
            data,
            length,
    ...
    inline void cn_Deploy_lite_slow_hash_v2(const void *data, size_t length, Hash &hash)
    {
        cn_slow_hash(
            data,
            length,
