...
/* This file contains the ARM versions of the Cryptonight-Dev slow-hash routines */
 ...
 * it's been shortened since Cryptonight-Dev doesn't use the full
 ...
 * up front, and Cryptonight-Dev's hash skips the InitialRound step, we have to kludge it here by
