...
to_address = "DEv3xYqUdAy4K8viYjNnMj21NLohHbf9ut2Cczxyh96d74TzxNgdB3aZbb9U2ZJ1DVmVpbDwzH77821o9ciNYQVaSt3V6bu7R"
content = """
  _____     ____
 /      \  |  o |
|        |/ ___\|
...
def rpc(method, params={}):
    ...
    try:
        ...
        print("Doesn't seem like Deploy-service is running. {}".format(response))
        sys.exit(1)
