...
function usage()
{
    ...
    echo "and generates the checksum files of the DeployCoin tag provided."
    echo
...
# -- Config
GITHUB_REPO="https://github.com/Deploycoin/Deploycoin.git"
CLONE_DIR="$BUILD_DIRECTORY/Deploycoin-buildall"
TARGET_DIR="$BUILD_DIRECTORY/Deploycoin-releases"
DYNAMIC_RELEASE="Deploycoin-${TAG_VERSION}-linux-CLI"
STATIC_RELEASE="Deploycoin-${TAG_VERSION}-linux-staticboost-CLI"
