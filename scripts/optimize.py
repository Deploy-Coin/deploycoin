# USAGE: Start Deploy-service as you usually would
...
from Deploycoin import Walletd as Wallet
import time
import argparse
parser = argparse.ArgumentParser()
parser.add_argument("--address", help="Deploycoin address to optimize", required=True)
